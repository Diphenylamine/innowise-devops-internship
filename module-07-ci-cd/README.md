...
После создания PR GitHub Actions автоматически запускает пайплайн.
Зелёная галочка — все тесты прошли, PR можно мержить.
Красный крестик — тесты упали, мерж заблокирован.